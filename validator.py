...
1. Run all tests for a given task:
  `python validator.py zad5 python main.py`

2. Running on other tests
  `python validator.py --testset large_tests.yaml zad5 python main.py`

3. Printing sample input/output:
  `python validator.py --show_example zad5`

4. Print solution information:
  `python validator.py --verbose zad5 python main.py`

5. Force STDIN/STDOUT to communicate:
  `python validator.py --stdio zad5 python main.py`

6. Setting a multiplier for time limits:
  `python validator.py --timeout-multiplier 2.5 zad5 python main.py`
'''
